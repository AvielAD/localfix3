...
const ResponsiveForm = () => {
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <form className="w-full max-w-lg bg-white shadow-md rounded-sm px-8 pt-6 pb-8 mb-4">
        <div className="mb-4">
        ...
        <div className="mb-6">
          ...
          <input
            className="shadow appearance-none border border-red-500 rounded-sm w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-hidden focus:shadow-outline"
            id="password"
            type="password"
            placeholder="******************"
          />
